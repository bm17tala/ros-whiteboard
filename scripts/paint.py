    ...
    def send_to_ROS(self):
        ...
        for i in range(0, len(processed_lines)):
            ...
            for j in range(startingPoint, len(processed_lines[i])):
                ...
                move_cmd.linear.x = 0.025 * math.cos(angle_rad)  # Forward motion along the angle
                move_cmd.linear.y = 0.025 * math.sin(angle_rad)  # Forward motion along the angle
                move_cmd.angular.z = 0
